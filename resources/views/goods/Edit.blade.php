...
<div class="mws-panel-body no-padding">
		...
		@if(session('error'))
          ...
          @endif
	<form class="mws-form" action="/admins/goods/update" method='post' enctype="multipart/form-data">
		<div class="mws-form-inline">
			<div class="mws-form-row">
				<label class="mws-form-label">商品名称</label>
				<div class="mws-form-item">
					<input type="text" name='title' value="{{$goods['title']}}" class="small">
				</div>
			</div>
			<div class="mws-form-row">
			...
			<div class="mws-form-row">
				...
				<div class="mws-form-item">
					<input type="text" name='kucun' value="{{$goods['kucun']}}" class="small">
				</div>
			</div>
			<div class="mws-form-row">
			...
			<div class="mws-form-row">
				...
				<div class="mws-form-item clearfix">
					<ul class="mws-form-list inline">
						<li><input type="checkbox" @if(in_array('32',explode(',',$goods['size']))) checked @endif name='size[]' value='32'> <label>32</label></li>
						...
						<li><input type="checkbox" @if(in_array('55',explode(',',$goods['size']))) checked @endif name='size[]' value="55"> <label>55</label></li>
						<li><input type="checkbox" @if(in_array('12',explode(',',$goods['size']))) checked @endif name='size[]' value="12"> <label>12</label></li>
					</ul>
				</div>
			</div>
			...
			<div class="mws-form-row">
				...
				<div class="mws-form-item">
					<script id="editor" type="text/plain" style="width:800px;height:500px;" name='content'>{!!$goods['content']!!}</script>
				</div>
			</div>
