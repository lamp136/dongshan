...
<div class="mws-panel grid_8">
  <div class="mws-panel-header">
    <span>
      <i class="icon-table"></i>权限列表</span>
  </div>
  <div class="mws-panel-body no-padding">
    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
   	<form action='/Permission/index' method='get'>
      ...
      <table class="mws-datatable mws-table dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
        <thead>
          <tr role="row">
            <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 170px;">权限ID</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 224px;">权限路由</th>
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
	        @foreach($per as $k=>$v)
	          ...
	          ">
	            ...
	            <td class=" ">
	            <!-- 修改和删除的连接 -->
	            <a href="/Permission/edit?id={{$v['id']}}" style='color:black;font-size:20px'><i class="icon-pencil-2"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
              <a href="/Permission/delete?id={{$v['id']}}" style='color:black;font-size:20px' onclick="return confirm('确定要删除权限吗')"><i class="icon-trash"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
	            </td>
	          </tr>
	        @endforeach
        </tbody>
